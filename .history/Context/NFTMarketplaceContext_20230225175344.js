...
const fetchMyNFTsOrListedNFTs = async (type) => {
  ...
  const buyNFT = async (nft) =>{
    ...
    return (
        ...
        <NFTMarketplaceContext.Provider value={{connectWallet,uploadToIPFS,createNFT,createSale,fetchNFTs,fetchMyNFTsOrListedNFTs,buyNFT,currentAccount,titlrData,}}>{children}</NFTMarketplaceContext.Provider>
    )
}